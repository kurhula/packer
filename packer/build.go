...
type CoreBuild struct {
	...
	HCL2PProcessorsPrepare func(builderArtifact Artifact) ([]CoreBuildPostProcessor, hcl.Diagnostics)
...
func (b *CoreBuild) Run(ctx context.Context, originalUi Ui) ([]Artifact, error) {
	...
	if b.HCL2PProcessorsPrepare != nil {
		postProcessors, diags := b.HCL2PProcessorsPrepare(builderArtifact)
		if diags.HasErrors() {
